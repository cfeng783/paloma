...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Terminal RATE Expr</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.xtext.edinburgh.paloma.impl.Terminal_RATE_ExprImpl#getLinkedParam <em>Linked Param</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class Terminal_RATE_ExprImpl extends MinimalEObjectImpl.Container implements Terminal_RATE_Expr
{
  /**
   ...
   * @generated
   */
  protected Terminal_RATE_ExprImpl()
  {
    super();
  }
  ...
  {
    return PalomaPackage.Literals.TERMINAL_RATE_EXPR;
  }
  ...
  public void setLinkedParam(String newLinkedParam)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, PalomaPackage.TERMINAL_RATE_EXPR__LINKED_PARAM, oldLinkedParam, linkedParam));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case PalomaPackage.TERMINAL_RATE_EXPR__LINKED_PARAM:
